...
questions = [
    ...
    {"question": "127. A quel mot anglais correspond : A strategic document that sets the overall direction of an organization and outlines how key objectives will be achieved over time ?", 
    ...
    {"question": "148. A quel mot anglais correspond : A concept used to describe situations characterized by volatility, uncertainty, complexity, and ambiguity ?", 
